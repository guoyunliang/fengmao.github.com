...
<p align=center><img src=/images/tair-1/tair_config_server_start.png width=474></p>
...
<p align=center><img src=/images/tair-1/tair_conf_thread_run.png width=600></p>

接下来分析load_group_file函数，该函数主要功能是获取配置文件，当配置文件版本号发生变化后，就会调用该函数，获取最新的配置信息；上代码，在代码中添加注释：

<p align=center><img src=/images/tair-1/load_group_file.png width=400></p>
...
<p align=center><img src=/images/tair-1/check_server_status.png width=584></p>
