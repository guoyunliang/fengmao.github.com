...
##概述 
Tair是分布式、高性能、可扩展、搞可靠性的存储系统。目前，Tair已成为开源项目，代码在: [click here](http://code.taobao.org/p/tair/src/.关于Tair)的更多介绍，见[TAIR wiki](http://code.taobao.org/p/tair/wiki/index/)。
