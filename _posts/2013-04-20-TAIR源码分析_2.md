...
<table align=center border="1" cellspacing="0" cellpadding="0" width="300" style="width: 200px; line-height: 10px; font-family: tahoma, Arial, 微软雅黑">
	<tbody>
		<tr>
...
<table align=center border="1" cellspacing="1" cellpadding="1" width="300" style="width: 200px; line-height: 10px; font-family: tahoma, Arial, 微软雅黑">
	<tbody>
		<tr>
...
###2.5.4 小结
2.5.*节主要介绍了对照表的构建。后续章节叙述数据迁移，请看<a href="http://fengmao.github.io/tair/2013/04/20/TAIR源代码分_3.html" target="_blank"> TAIR源代码分析<3></a>
